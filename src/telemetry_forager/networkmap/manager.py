...
class NetworkMapManager:
    ...
    def get_unique_src_subscription(self,
                               start_time: datetime, 
                               end_time: datetime,
                               flow_types: list[str] = [],
                               flow_direction: str = 'all',
    ...
    def get_unique_src_subnet(self,
                               start_time: datetime, 
                               end_time: datetime,
                               flow_types: list[str] = [],
                               flow_direction: str = 'all',
    ...
    def get_unique_dest_subnet(self,
                               start_time: datetime, 
                               end_time: datetime,
                               flow_types: list[str] = [],
                               flow_direction: str = 'all',
