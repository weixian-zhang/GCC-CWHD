...
class NetworkMapManager:
    ...
    def _create_echart_nodes(self, maindf: pd.DataFrame) -> dict:
        ...
        src_nodes_final_df['azurePublicSrcPIPLocation'] = maindf['AzurePublic_SrcPIP_Location']
        src_nodes_final_df['externalPublicSrcCountry'] = maindf['ExternalPublic_Src_Country']
        ...
        dest_nodes_final_df['externalPublicDestCountry'] = maindf['ExternalPublic_Dest_Country']
