...
## Coming Soon  
* [WAF Reliability Assessment (WARA)](https://learn.microsoft.com/en-us/azure/well-architected/reliability/) on Grafana
* Ready-to-use Grafana dashboard templates
...
## Azure Telemtry Required
   ...
   *  PaaS services - enable Diagnostic Settings for all PaaS services under monitoring
